        ...
        <main>
            <div className='row container mt-3 align-items-center'>
                ...
                <div className='col-lg-6 col-md-7'>
                    ...
                    <p className='mb-4 mt-3'>The Mercedes-Benz V-Class combines comfort and luxury on a large scale. GUARD: Special protection version of the new S-Class. Unique integrated concept meets highest protection level for civilian vehicles. The new S 680 GUARD 4MATIC.</p>
